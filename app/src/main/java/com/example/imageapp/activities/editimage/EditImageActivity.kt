package com.example.imageapp.activities.editimage
...
import com.example.imageapp.activities.main.MainActivity
import com.example.imageapp.adapters.ImageFiltersAdapter
import com.example.imageapp.data.ImageFilter
import com.example.imageapp.databinding.ActivityEditImageBinding
import com.example.imageapp.listeners.ImageFilterListener
import com.example.imageapp.utilities.displayToast
import com.example.imageapp.utilities.show
...
class EditImageActivity : AppCompatActivity(), ImageFilterListener {
    ...
    private fun setupObservers () {
        ...
        viewModel.saveFilteredImageUiState.observe(this, {
            ...
            } ?: kotlin.run { saveFilteredImageDataState.error?.let { error ->
                displayToast(error)
            } }
        })
    }
